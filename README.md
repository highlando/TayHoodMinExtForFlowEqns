...
The simulations are started from the file `comp_timeschemes_main.py`. There all parameters are set. The default values of internal parameters of the first commit are the ones used in the simulations presented in the paper.
